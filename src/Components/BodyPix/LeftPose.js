...
const drawDynamicSkeletonRight = (poses, ctx) => {
    ...
    poses.forEach((pose) => {
        ...
        const leftSideDetected = (leftWrist && leftWrist.score > 0.5) && (rightWrist && rightWrist.score > 0.5);


        let colorStyle = leftSideDetected ? 'green' : 'red';
